package com.cjb.hospital.constants;
...
public interface ApiConstant {
    ...
    String getHospitals = "/com.cjb.hospital/queryall";//查询所有医院
    String getdepartmentsbyhid = "/com.cjb.hospital/queryByHospitalId/";
    ...
    String queryDoctorById = "/doctor/queryDoctorByDoctorAccount";
    ...
    String startappointment = "/appointment/startAppointment";
    String timeoutappointment = "/appointment/timeOutAppointment";
    String completeappointment = "/appointment/completeAppointment";
    String getAppointmentInfo = "/appointment/getAppointmentDetail";
