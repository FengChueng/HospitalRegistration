package com.zyl.hospital.registration.widget.launcher;
...
import com.zyl.hospital.registration.utils.DimenUtils;
...
public class LauncherView extends RelativeLayout {
    private int mHeight;
    private int mWidth;
    private int dp80 = DimenUtils.dp2px(getContext(), 80);
    ...
    private void showLogo() {
        ...
        final ShimmerTextView slogo = (ShimmerTextView) view.findViewById(R.id.tv_logo);
